...
const timerTemplate = `<svg xmlns="http://www.w3.org/2000/svg" class="timer" viewBox="0 0 780 780">
      <circle
        cx="390" cy="390" r="370"
        class="timer-line"
...
const notesTemplate = `<div class="main-mistakes">
...
export {logoTemplate, timerTemplate, notesTemplate, playerWrapperTemplate, replayButtonTemplate};
